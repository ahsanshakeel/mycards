...
namespace MyCard.Web.Models
{
    public class CompanyEditViewModel
    {
        ...
        [Display(Name = "Name", ResourceType = typeof(MyCard.Web.Resources.CaptionsAll))]
        ...
        //[RegularExpression(@"^\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$", ErrorMessage = "InvalidPhone")]
        //[RegularExpression(@"^(?([0-9]{3}))?[-. ]?([0-9]{3})[-. ]?([0-9]{4}).*$", ErrorMessage = "InvalidPhone")]
        //[Phone(ErrorMessageResourceType = (typeof(MyCard.Web.Resources.ErrorMessages)), ErrorMessageResourceName = "InvalidPhone")]
        ...
        [Display(Name = "CompanyLogo", ResourceType = typeof(MyCard.Web.Resources.CaptionsAll))]
