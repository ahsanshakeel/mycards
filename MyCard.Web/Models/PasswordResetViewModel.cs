...
namespace MyCard.Web.Models
{
    public class PasswordResetViewModel
    {
        ...
        //[StringLength(255, ErrorMessageResourceType = (typeof(MyCard.Web.Resources.ErrorMessages)), ErrorMessageResourceName = "PasswordLengthErrorMessage", MinimumLength = 5)]
        [DataType(DataType.Password)]
