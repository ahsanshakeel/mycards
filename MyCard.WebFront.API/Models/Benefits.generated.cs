...
namespace MyCard.WebFront.API.Models
{
	...
	public partial class Benefits : PublishedContentModel
	{
...
#pragma warning restore 0109
		...
		/// Benefit Image
		///</summary>
		[ImplementPropertyType("benefitImage")]
		public IPublishedContent BenefitImage
		{
			get { return this.GetPropertyValue<IPublishedContent>("benefitImage"); }
		}

		///<summary>
		/// Benefit Text
		///</summary>
		[ImplementPropertyType("benefitText")]
		public string BenefitText
		{
			get { return this.GetPropertyValue<string>("benefitText"); }
		}
	}
}
